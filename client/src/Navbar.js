    ...
    <div>
      <div ref={(el) => (NavSlide = el)}>
        ...
        <NavAlign>
          ...
          {user && (
            <NavItem>
              <StyledNavLink href="/saved-countries-list">
                Places To Go
              </StyledNavLink>
            </NavItem>
          )}
          ...
          {!user && (
            <NavItem>
              <Button outline color="dark" onClick={toggleRegister}>
                Register
              </Button>
              &nbsp;&nbsp;&nbsp;
            </NavItem>
          ...
          {!user && (
            <NavItem>
              <Button outline color="dark" onClick={toggleLogin}>
                Login
              </Button>
            </NavItem>
          )}
